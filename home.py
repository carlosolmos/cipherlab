...
st.set_page_config(page_title="Cryptography Lab by Carlos Olmos")
st.header("Cryptography Lab")
...
I plan to work with the concepts of cryptography and cryptanalysis history —as laid out by Singh in his book— by implementing \
...
st.markdown("""Carlos Olmos

[carlosolmos.dev](https://carlosolmos.dev)""")
